# Taux de scolarisation selon l'âge et le sexe 

# Rapelle le nombre de personnes par tranches d'âge et par sexe en terme de code, c'est pop_t4
...
View(r)
# Il y a 38 modalités, je vais pas les citer à la main, on va tenter les str
# Dans le tableau sur insee.fr il y a que 7 
# FOR_T3 est vide et for_t2 a les données qui devraien être dans T3 
