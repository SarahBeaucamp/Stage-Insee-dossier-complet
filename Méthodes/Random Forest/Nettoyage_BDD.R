...
# Les seuils de population à tester
seuils <- c(0, 100, 250, 500, 1000)

# Un tableau vide pour stocker nos résultats
resultats_seuils <- data.frame(Seuil = integer(), 
...
for (seuil in seuils) {
  ...
  # 5. Évaluation de la Baseline (Moyenne naïve)
  ...
  resultats_seuils <- rbind(resultats_seuils, data.frame(
    Seuil = seuil, 
